...
class AliNet:
    ...
    def compute_loss(self, pos_links, neg_links, only_pos=False):
        ...
        print('embeds1=',embeds1)
        print('embeds2=',embeds2)
        pos_loss = tf.reduce_sum(tf.reduce_sum(tf.square(embeds1 - embeds2), 1))
        score_cosine = tf.losses.cosine_similarity(embeds1,embeds2)
        print('score_cosine=',score_cosine)
