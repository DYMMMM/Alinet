...
parser.add_argument('--input', type=str, default="/home/nlp/users/MM/code/data/DBP15k/zh_en/mtranse/0_3/")
parser.add_argument('--output', type=str, default="/home/nlp/users/MM/code/data/output/results/")

parser.add_argument('--embedding_module', type=str, default='AliNet')
parser.add_argument('--layer_dims', type=list, default=[200,100,50])  # [300, 200, 100] for two layers############[500,400,300]
...
parser.add_argument('--batch_size', type=int, default=4500)####################4500
